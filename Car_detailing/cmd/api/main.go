...
import (
	...
	"car_detailing.arsennusip.net/internal/mailer"
	"context"      // New import
...
func main() {
	...
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "CAR DETAILING <no-reply@car_detailing.arsennusip.net>", "SMTP sender")
